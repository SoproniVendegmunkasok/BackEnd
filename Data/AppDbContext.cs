    ...
    public class AppDbContext : IdentityDbContext<User>
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<User>().HasData(
                new User { Id = "-1", UserName = "user1", NormalizedUserName = "USER1", Email = "user1@example.com", NormalizedEmail = "USER1@EXAMPLE.COM", EmailConfirmed = true, PasswordHash = "AQAAAAEAACcQAAAAE1234567ABCDEFGHIJKLMNOPQRSTUVWXYZ", SecurityStamp = "ABC123", ConcurrencyStamp = "XYZ123" },
                new User { Id = "-2", UserName = "user2", NormalizedUserName = "USER2", Email = "user2@example.com", NormalizedEmail = "USER2@EXAMPLE.COM", EmailConfirmed = true, PasswordHash = "AQAAAAEAACcQAAAAE2345678ABCDEFGHIJKLMNOPQRSTUVWXYZ", SecurityStamp = "DEF456", ConcurrencyStamp = "UVW456" },
                new User { Id = "-3", UserName = "user3", NormalizedUserName = "USER3", Email = "user3@example.com", NormalizedEmail = "USER3@EXAMPLE.COM", EmailConfirmed = true, PasswordHash = "AQAAAAEAACcQAAAAE3456789ABCDEFGHIJKLMNOPQRSTUVWXYZ", SecurityStamp = "GHI789", ConcurrencyStamp = "RST789" },
                new User { Id = "-4", UserName = "user4", NormalizedUserName = "USER4", Email = "user4@example.com", NormalizedEmail = "USER4@EXAMPLE.COM", EmailConfirmed = true, PasswordHash = "AQAAAAEAACcQAAAAE4567890ABCDEFGHIJKLMNOPQRSTUVWXYZ", SecurityStamp = "JKL012", ConcurrencyStamp = "OPQ012" }
